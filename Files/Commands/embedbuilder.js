...
module.exports = {
  ...
  async builder(msg, answer) {
    ...
    const allButtons = msg.client.ch.buttonRower([
      [
        {
          custom_id: msg.lanEmbed.title.title,
          disabled: false,
          emoji: null,
        ...
        {
          custom_id: msg.lanEmbed.author.author,
          disabled: false,
          emoji: null,
        ...
        {
          custom_id: msg.lanEmbed.thumbnail.thumbnail,
          disabled: false,
          emoji: null,
      ...
      [
        {
          custom_id: msg.lanEmbed.description.description,
          disabled: false,
          emoji: null,
        ...
        {
          custom_id: msg.lanEmbed.color.color,
          disabled: false,
          emoji: null,
        ...
        {
          custom_id: msg.lanEmbed.image.image,
          disabled: false,
          emoji: null,
        ...
        {
          custom_id: msg.lanEmbed.field.field,
          disabled: false,
          emoji: null,
      ...
      [
        {
          custom_id: msg.lanEmbed.footer.footer,
          disabled: false,
          emoji: null,
        ...
        {
          custom_id: msg.lanEmbed.timestamp.timestamp,
          disabled: false,
          emoji: null,
    ...
    async function repeater() {
      ...
      if (answer) answer.update({ embeds: [FinishedEmbed, SettingsEmbed], components: allButtons });
        ...
        msg.client.ch.reply(msg, {
          embeds: [FinishedEmbed, SettingsEmbed],
      ...
      const promise = await new Promise((resolve) => {
        ...
        messageCollector.on('collect', (message) => {
          if (
            ...
            return msg.client.ch.aborted(msg, [messageCollector, buttonsCollector]);
        });
      });
      if (!promise) return msg.client.ch.aborted(msg);
      editing = Object.entries(msg.language.embedBuilder.embed).find(
        (a) => Object.entries(a[1])[0][1] == editing,
      )[1];
      if (editing) {
        if (Object.entries(editing).length > 1) {
          const Buttons = [];
          Object.entries(editing).forEach((e) => {
            if (e[0] !== e[1].toLowerCase())
              Buttons.push({
                custom_id: e[1],
                disabled: false,
                emoji: null,
          ...
          if (answer)
            answer.update({ embeds: [FinishedEmbed, SettingsEmbed], components: Buttons2 });
          else if (msg.m)
            msg.client.ch.reply(msg, {
              embeds: [FinishedEmbed, SettingsEmbed],
              components: Buttons2,
