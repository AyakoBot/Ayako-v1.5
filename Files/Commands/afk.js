module.exports = {
  ...
  async execute(msg) {
    ...
    if (msg.args[0])
      text = msg.client.ch.stp(lan.afkText2, {
        slice: msg.args.slice(0).join(' '),
    ...
    if (res && res.rowCount > 0) {
      ...
      if (msg.args[0])
        msg.client.ch.reply(
          msg,
          msg.client.ch.stp(lan.updatedTo, { text: msg.args.slice(0).join(' ') }),
        );
      ...
      if (msg.args[0])
        msg.client.ch.reply(
          msg,
          msg.client.ch.stp(lan.setTo, { text: msg.args.slice(0).join(' ') }),
        );
