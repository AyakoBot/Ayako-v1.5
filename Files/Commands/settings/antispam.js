...
module.exports = {
	...
	editEmbed(msg, r) {
		const embed = new Discord.MessageEmbed()
			.addFields(
				{name: msg.client.ch.stp(msg.lan.edit.antispamtof.name, {trigger: msg.lan.edit.antispamtof.trigger.includes('`') ? msg.lan.edit.antispamtof.trigger : msg.lan.edit.antispamtof.trigger.map(f => `\`${f}\``)}), value: `${r.antispamtof ? msg.client.constants.emotes.tick+' '+msg.language.enabled : msg.client.constants.emotes.cross+' '+msg.language.disabled}`, inline: false},
				{name: msg.client.ch.stp(msg.lan.edit.bpchannelid.name, {trigger: msg.lan.edit.bpchannelid.trigger.includes('`') ? msg.lan.edit.bpchannelid.trigger : msg.lan.edit.bpchannelid.trigger.map(f => `\`${f}\``)}), value: `${r.bpchannelid && r.bpchannelid !== [] ? `${r.bpchannelid.map(id => ` <#${id}>`)}`.length > 0 ? r.bpchannelid.map(id => ` <#${id}>`) : msg.language.none : msg.language.none}`, inline: false},
				{name: msg.client.ch.stp(msg.lan.edit.bpuserid.name, {trigger: msg.lan.edit.bpuserid.trigger.includes('`') ? msg.lan.edit.bpuserid.trigger : msg.lan.edit.bpuserid.trigger.map(f => `\`${f}\``)}), value: `${r.bpuserid && r.bpuserid !== [] ? `${r.bpuserid.map(id => ` <@${id}>`)}`.length > 0 ? r.bpuserid.map(id => ` <@${id}>`) : msg.language.none : msg.language.none}`, inline: false},
				{name: msg.client.ch.stp(msg.lan.edit.bproleid.name, {trigger: msg.lan.edit.bproleid.trigger.includes('`') ? msg.lan.edit.bproleid.trigger : msg.lan.edit.bproleid.trigger.map(f => `\`${f}\``)}), value: `${r.bproleid && r.bproleid !== [] ? `${r.bproleid.map(id => ` <@&${id}>`)}`.length > 0 ? r.bproleid.map(id => ` <@&${id}>`) : msg.language.none : msg.language.none}`, inline: false},
				{name: '\u200b', value: '\u200b', inline: false},
				{name: '\u200b', value: `${msg.client.ch.stp(msg.lan.edit.readofwarnstof.name, {trigger: msg.lan.edit.readofwarnstof.trigger.includes('`') ? msg.lan.edit.readofwarnstof.trigger : msg.lan.edit.readofwarnstof.trigger.map(f => `\`${f}\``)})}\n${r.readofwarnstof ? msg.client.constants.emotes.tick+' '+msg.language.enabled : msg.client.constants.emotes.cross+' '+msg.language.disabled}\n\n${msg.client.ch.stp(msg.lan.edit.muteafterwarnsamount.name, {amount: r.muteafterwarnsamount, trigger: msg.lan.edit.muteafterwarnsamount.trigger.includes('`') ? msg.lan.edit.muteafterwarnsamount.trigger : msg.lan.edit.muteafterwarnsamount.trigger.map(f => `\`${f}\``)})}\n${msg.client.ch.stp(msg.lan.edit.kickafterwarnsamount.name, {amount: r.kickafterwarnsamount, trigger: msg.lan.edit.kickafterwarnsamount.trigger.includes('`') ? msg.lan.edit.kickafterwarnsamount.trigger : msg.lan.edit.kickafterwarnsamount.trigger.map(f => `\`${f}\``)})}\n${msg.client.ch.stp(msg.lan.edit.banafterwarnsamount.name, {amount: r.banafterwarnsamount, trigger: msg.lan.edit.banafterwarnsamount.trigger.includes('`') ? msg.lan.edit.banafterwarnsamount.trigger : msg.lan.edit.banafterwarnsamount.trigger.map(f => `\`${f}\``)})}`, inline: false},
				{name: '\u200b', value: '\u200b', inline: false},
				{name: msg.client.ch.stp(msg.lan.edit.giveofficialwarnstof.name, {trigger: msg.lan.edit.giveofficialwarnstof.trigger.includes('`') ? msg.lan.edit.giveofficialwarnstof.trigger : msg.lan.edit.giveofficialwarnstof.trigger.map(f => `\`${f}\``)}), value: `${r.giveofficialwarnstof ? msg.client.constants.emotes.tick+' '+msg.language.enabled : msg.client.constants.emotes.cross+' '+msg.language.disabled}`, inline: true},
				{name: msg.client.ch.stp(msg.lan.edit.muteenabledtof.name, {trigger: msg.lan.edit.muteenabledtof.trigger.includes('`') ? msg.lan.edit.muteenabledtof.trigger : msg.lan.edit.muteenabledtof.trigger.map(f => `\`${f}\``)}), value: `${r.muteenabledtof ? msg.client.constants.emotes.tick+' '+msg.language.enabled : msg.client.constants.emotes.cross+' '+msg.language.disabled}`, inline: true},
				{name: msg.client.ch.stp(msg.lan.edit.kickenabledtof.name, {trigger: msg.lan.edit.kickenabledtof.trigger.includes('`') ? msg.lan.edit.kickenabledtof.trigger : msg.lan.edit.kickenabledtof.trigger.map(f => `\`${f}\``)}), value: `${r.kickenabledtof ? msg.client.constants.emotes.tick+' '+msg.language.enabled : msg.client.constants.emotes.cross+' '+msg.language.disabled}`, inline: true},
				{name: msg.client.ch.stp(msg.lan.edit.banenabledtof.name, {trigger: msg.lan.edit.banenabledtof.trigger.includes('`') ? msg.lan.edit.banenabledtof.trigger : msg.lan.edit.banenabledtof.trigger.map(f => `\`${f}\``)}), value: `${r.banenabledtof ? msg.client.constants.emotes.tick+' '+msg.language.enabled : msg.client.constants.emotes.cross+' '+msg.language.disabled}`, inline: true},
			);
		return embed;
	},
	buttons(msg, r) {
