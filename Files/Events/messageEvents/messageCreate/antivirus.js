...
const getBadLinks = () => {
  const file = fs.readFileSync('/root/Bots/Ayako-VueJS/Website-CDN/antivirus/badLinks.txt', {
    encoding: 'utf8',
  });
...
const saveToBadLink = async (linkObject, msg, hrefLogging) => {
  ...
  if (!res.includes(linkObject.baseURL)) {
    ...
    fs.appendFile('/root/Bots/Ayako-VueJS/Website-CDN/antivirus/badLinks.txt', `\n${appended}`, () => {});
