...
const announcement = async (voter, usedRole) => {
  ...
  webhook.send({
    content: `Thanks **${
      ...
      usedRole
        ? `\nYou have been given ${usedRole} as gift for the next 12 Hours and 120 <a:AMAyakoBookGIF:1010325150949969930>~`
        : 'You have been given 120 <a:AMAyakoBookGIF:1010325150949969930>~'
    }`,
    allowedMentions: {
      users: [],
      roles: [],
